...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EsInfo) DeepCopyInto(out *EsInfo) {
	*out = *in
	out.Auth = in.Auth
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EsInfo.
func (in *EsInfo) DeepCopy() *EsInfo {
	if in == nil {
		return nil
	}
	out := new(EsInfo)
