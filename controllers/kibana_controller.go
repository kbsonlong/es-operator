/*
 * @FilePath: /controllers/kibana_controller.go
 * @Author: kbsonlong kbsonlong@gmail.com
 * @Date: 2023-10-10 10:40:59
 * @LastEditors: kbsonlong kbsonlong@gmail.com
 * @LastEditTime: 2023-10-10 16:49:39
 * @Description:
...
//+kubebuilder:rbac:groups=db.alongparty.cn,resources=kibanas,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=db.alongparty.cn,resources=kibanas/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=db.alongparty.cn,resources=kibanas/finalizers,verbs=update
...
func (r *KibanaReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	k8s.ReconcileDeploymant(ctx, kb, req, r.Client, r.Scheme)
	k8s.ReconcileKibanaServices(ctx, kb, req, r.Client, r.Scheme)
